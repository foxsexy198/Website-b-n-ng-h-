...
if( !empty($addtocart_link) ) {
	?>
	<br />
	<form action="<?php echo  $mm_action_url ?>index.php" method="post" class="addtocart_form" name="addtocart" id="<?php echo uniqid('addtocart_') ?>" <?php if( $this->get_cfg( 'useAjaxCartActions', 1 ) && !$notify ) { echo 'onsubmit="handleAddToCart( this.id );return false;"'; } ?>>
